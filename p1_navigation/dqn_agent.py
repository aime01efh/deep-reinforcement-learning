# Adapted from the Deep Reinforcement Learning Nanodegree
...
class Agent():
    ...
    def act(self, state, eps=0., train=True):
        ...
        self.qnetwork_local.train(train)
    ...
    def soft_update(self, local_model, target_model, tau):
        ...
        """
        param_zip = zip(target_model.parameters(), local_model.parameters())
        for target_param, local_param in param_zip:
